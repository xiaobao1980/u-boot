...
#define HF_FEDP_CK_UPDATE				BIT(5)
#define CLK_CFG_9_SET					(TOPCKGEN_BASE + 0x90)
#define CLK_CFG_9_CLR					(TOPCKGEN_BASE + 0x94)
#define CLK_HF_FEDP_CK_SEL_MASK				0xf00
#define CLK_HF_FEDP_CK_SEL_SHIFT			8
#define PDN_HF_FEDP_CK					BIT(15)

/* TVPDLL Control Registers */
#define TVDPLL_CON0					(APMIXEDSYS_BASE + 0x524)
...
#define TVDPLL_CON1					(APMIXEDSYS_BASE + 0x528)
...
#define TVDPLL_CON3					(APMIXEDSYS_BASE + 0x530)
...
#define DISP_REG_POSTMASK_EN_ENABLE			BIT(0)

#define DISP_REG_POSTMASK_CFG				(DISPSYS_POSTMASK0_BASE + 0x020)
#define DISP_REG_POSTMASK_CFG_STALL_CG_ON		BIT(8)
#define DISP_REG_POSTMASK_CFG_GCLAST_ENABLE		BIT(6)
#define DISP_REG_POSTMASK_CFG_BGCLR_IN_SEL		BIT(2)
#define DISP_REG_POSTMASK_CFG_DRAM_MODE			BIT(1)
#define DISP_REG_POSTMASK_CFG_RELAY_MODE_ENABLE		BIT(0)

#define DISP_REG_POSTMASK_SIZE				(DISPSYS_POSTMASK0_BASE + 0x030)
#define DISP_REG_POSTMASK_SIZE_WIDTH_SHIFT		16
#define DISP_REG_POSTMASK_SIZE_WIDTH_MASK		0x1fff
#define DISP_REG_POSTMASK_SIZE_HEIGHT_MASK		0x1fff
...
/* SMI_LARB */
#define DISPSYS_SMI_LARB0_FORCE_ULTRA			(DISPSYS_SMI_LARB0_BASE + 0x078)
#define DISPSYS_SMI_LARB0_FORCE_ALL_ULTRA		0xffffffff

/* Config */
#define MT8188_VDO0_OVL_GLOBAL_CG_CLR0			(VDOSYS0_CONFIG_BASE + 0x108)
#define MT8188_VDO0_OVL_GLOBAL_CG_B29_DISP_COLOR0	BIT(29)
#define MT8188_VDO0_OVL_GLOBAL_CG_B28_APB_BUS		BIT(28)
#define MT8188_VDO0_OVL_GLOBAL_CG_B26_DISP_AAL0		BIT(26)
#define MT8188_VDO0_OVL_GLOBAL_CG_B25_DP_INTF0		BIT(25)
#define MT8188_VDO0_OVL_GLOBAL_CG_B21_DSI0		BIT(21)
#define MT8188_VDO0_OVL_GLOBAL_CG_B19_DISP_RDMA0	BIT(19)
#define MT8188_VDO0_OVL_GLOBAL_CG_B10_DISP_DITHER0	BIT(10)
#define MT8188_VDO0_OVL_GLOBAL_CG_B8_DISP_GAMMA0	BIT(8)
#define MT8188_VDO0_OVL_GLOBAL_CG_B6_DISP_MUTEX0	BIT(6)
#define MT8188_VDO0_OVL_GLOBAL_CG_B4_DISP_CCORR0	BIT(4)
#define MT8188_VDO0_OVL_GLOBAL_CG_B0_DISP_OVL0		BIT(0)

#define MT8188_VDO0_OVL_GLOBAL_CG_CLR1			(VDOSYS0_CONFIG_BASE + 0x118)
#define MT8188_VDO0_OVL_GLOBAL_CG_B15_SMI_RSI		BIT(15)
#define MT8188_VDO0_OVL_GLOBAL_CG_B14_SMI_LARM		BIT(14)
#define MT8188_VDO0_OVL_GLOBAL_CG_B13_SMI_IOMMU		BIT(13)
#define MT8188_VDO0_OVL_GLOBAL_CG_B12_SMI_EMI		BIT(12)
#define MT8188_VDO0_OVL_GLOBAL_CG_B11_SMI_COMMON	BIT(11)
#define MT8188_VDO0_OVL_GLOBAL_CG_B10_SMI_GALS		BIT(10)
#define MT8188_VDO0_OVL_GLOBAL_CG_B0_DISP_POSTMASK0	BIT(0)

#define MT8188_VDO0_OVL_GLOBAL0_SW0_RST_B		(VDOSYS0_CONFIG_BASE + 0x190)
#define MT8188_VDO0_OVL_MOUT_EN				(VDOSYS0_CONFIG_BASE + 0xf14)
#define MT8188_VDO0_OVL_MOUT_EN_OUTPUT_TO_RDMA0		BIT(0)

#define MT8188_VDO0_DISP_RDMA_SEL			(VDOSYS0_CONFIG_BASE + 0xf40)
#define MT8188_VDO0_DISP_RDMA_SEL_TO_COLOR0		0x0

#define MT8188_VDO0_DSI0_SEL				(VDOSYS0_CONFIG_BASE + 0xf44)
#define MT8188_VDO0_DSI0_IN_FROM_DITHER0_OUT		BIT(0)

#define MT8188_VDO0_DP_INTF0_SEL			(VDOSYS0_CONFIG_BASE + 0xf4c)
#define MT8188_VDO0_DP_INTF0_IN_FROM_VPP_MERGE0		BIT(0)

#define MT8188_VDO0_DISP_DITHER0_SEL			(VDOSYS0_CONFIG_BASE + 0xf58)
#define MT8188_VDO0_DISP_DITHER0_OUT_TO_DSI0		BIT(0)

#define MT8188_VDO0_VPP_MERGE_SEL			(VDOSYS0_CONFIG_BASE + 0xf60)
#define MT8188_VDO0_VPP_MERGE_IN_FROM_DSC_WRAP0		0x0
#define MT8188_VDO0_VPP_MERGE_OUT_SHIFT			4
#define MT8188_VDO0_VPP_MERGE_OUT_TO_DP_INTF0		BIT(0)

#define MT8188_VDO0_DSC_WRAP_SEL			(VDOSYS0_CONFIG_BASE + 0xf64)
#define MT8188_VDO0_DSC_WRAP_IN_FROM_DITHER0		0x0
#define MT8188_VDO0_DSC_WRAP_OUT_SHIFT			16
#define MT8188_VDO0_DSC_WRAP_OUT_TO_VPP_MERGE0		BIT(2)
...
#define DISP_MUTEX0_VDO0_DISP_POSTMASK0			BIT(24)
